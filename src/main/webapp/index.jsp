	...
	<div id="carouselExampleIndicators" class="carousel slide">
	  ...
	  <div class="carousel-inner">
	    ...
	    <div class="carousel-item">
	      <img src="img/hos2jpg.jpg" class="d-block w-100" alt="..." height="500px">
	    </div>
	    <div class="carousel-item">
	...
	<div class="container p-3">
		...
		<div class="row">
			<div class="col-md-8 p-5">
				<div class="row">
					<div class="col-md-6">
						<div class="card paint-card m-1">
							<div class="card-body">
								<p class="fs-5">100% Safety</p>
								<p>lorem ipsum dolor sit amet,constettute ametnt .
								volupetutm , inventute</p>
							</div>
						</div>
					</div>
					<div class="col-md-6">
			...
			<div class="col-md-4">
				<img alt="" src="img/doctor.jpg" height="400px">
			</div>
		</div>
	</div>
	<hr>
